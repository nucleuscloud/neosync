...
class ApiKeyService(object):
    ...
    def GetAccountApiKeys(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/mgmt.v1alpha1.ApiKeyService/GetAccountApiKeys',
    ...
    def GetAccountApiKey(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/mgmt.v1alpha1.ApiKeyService/GetAccountApiKey',
    ...
    def CreateAccountApiKey(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/mgmt.v1alpha1.ApiKeyService/CreateAccountApiKey',
    ...
    def RegenerateAccountApiKey(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/mgmt.v1alpha1.ApiKeyService/RegenerateAccountApiKey',
    ...
    def DeleteAccountApiKey(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/mgmt.v1alpha1.ApiKeyService/DeleteAccountApiKey',
