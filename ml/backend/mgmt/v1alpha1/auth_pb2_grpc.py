...
class AuthService(object):
    ...
    def LoginCli(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/mgmt.v1alpha1.AuthService/LoginCli',
    ...
    def RefreshCli(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/mgmt.v1alpha1.AuthService/RefreshCli',
    ...
    def CheckToken(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/mgmt.v1alpha1.AuthService/CheckToken',
    ...
    def GetCliIssuer(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/mgmt.v1alpha1.AuthService/GetCliIssuer',
    ...
    def GetAuthorizeUrl(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/mgmt.v1alpha1.AuthService/GetAuthorizeUrl',
    ...
    def GetAuthStatus(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/mgmt.v1alpha1.AuthService/GetAuthStatus',
