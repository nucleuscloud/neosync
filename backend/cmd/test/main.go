...
func buildQuery(table string, data QueryData, whereClauses map[string]string, visited map[string]bool, shouldSubsetMap map[string]bool) ([]*sqlJoin, []string) {
...
func SubsetQueries(data QueryData, whereClauses map[string]string, shouldSubsetMap map[string]bool) {
...
func main() {
	...
	// SubsetQueries(queryData, whereClauses, parentsMap)
