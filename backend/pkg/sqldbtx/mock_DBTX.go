...
func (_m *MockDBTX) BeginTx(_a0 context.Context, _a1 *sql.TxOptions) (*sql.Tx, error) {
...
//   - _a0 context.Context
//   - _a1 *sql.TxOptions
func (_e *MockDBTX_Expecter) BeginTx(_a0 interface{}, _a1 interface{}) *MockDBTX_BeginTx_Call {
	return &MockDBTX_BeginTx_Call{Call: _e.mock.On("BeginTx", _a0, _a1)}
}

func (_c *MockDBTX_BeginTx_Call) Run(run func(_a0 context.Context, _a1 *sql.TxOptions)) *MockDBTX_BeginTx_Call {
...
func (_c *MockDBTX_BeginTx_Call) Return(_a0 *sql.Tx, _a1 error) *MockDBTX_BeginTx_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockDBTX_BeginTx_Call) RunAndReturn(run func(context.Context, *sql.TxOptions) (*sql.Tx, error)) *MockDBTX_BeginTx_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockDBTX) PingContext(_a0 context.Context) error {
	ret := _m.Called(_a0)
...
//   - _a0 context.Context
func (_e *MockDBTX_Expecter) PingContext(_a0 interface{}) *MockDBTX_PingContext_Call {
	return &MockDBTX_PingContext_Call{Call: _e.mock.On("PingContext", _a0)}
}

func (_c *MockDBTX_PingContext_Call) Run(run func(_a0 context.Context)) *MockDBTX_PingContext_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockDBTX_PingContext_Call) Return(_a0 error) *MockDBTX_PingContext_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockDBTX_PingContext_Call) RunAndReturn(run func(context.Context) error) *MockDBTX_PingContext_Call {
	_c.Call.Return(run)
	return _c
}
