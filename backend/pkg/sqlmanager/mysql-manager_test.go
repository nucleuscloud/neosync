		...
		[]*mysql_queries.GetDatabaseSchemaRow{
			{
				...
				ColumnDefault:          "",
				IsNullable:             "NO",
				CharacterMaximumLength: sql.NullInt32{Int32: int32(220)},
				NumericPrecision:       sql.NullInt32{Int32: int32(-1)},
				NumericScale:           sql.NullInt32{Int32: int32(-1)},
				OrdinalPosition:        4,
			},
			{
				TableSchema:            "public",
				...
				ColumnDefault:          "",
				IsNullable:             "NO",
				CharacterMaximumLength: sql.NullInt32{Int32: int32(-1)},
				NumericPrecision:       sql.NullInt32{Int32: int32(32)},
				NumericScale:           sql.NullInt32{Int32: int32(0)},
				OrdinalPosition:        5,
			},
		}, nil,
	)
