...
import (
	sqldbtx "github.com/nucleuscloud/neosync/backend/pkg/sqldbtx"
...
func (_m *MockSqlDbContainer) Open() (sqldbtx.DBTX, error) {
	ret := _m.Called()
	...
	var r0 sqldbtx.DBTX
	var r1 error
	if rf, ok := ret.Get(0).(func() (sqldbtx.DBTX, error)); ok {
		return rf()
	}
	if rf, ok := ret.Get(0).(func() sqldbtx.DBTX); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(sqldbtx.DBTX)
		}
	}
...
func (_c *MockSqlDbContainer_Open_Call) Return(_a0 sqldbtx.DBTX, _a1 error) *MockSqlDbContainer_Open_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockSqlDbContainer_Open_Call) RunAndReturn(run func() (sqldbtx.DBTX, error)) *MockSqlDbContainer_Open_Call {
	_c.Call.Return(run)
	return _c
}
