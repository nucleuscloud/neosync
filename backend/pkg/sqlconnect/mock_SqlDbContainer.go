...
func (_m *MockSqlDbContainer) Open() (*sql.DB, error) {
	ret := _m.Called()
...
func (_c *MockSqlDbContainer_Open_Call) Return(_a0 *sql.DB, _a1 error) *MockSqlDbContainer_Open_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockSqlDbContainer_Open_Call) RunAndReturn(run func() (*sql.DB, error)) *MockSqlDbContainer_Open_Call {
	_c.Call.Return(run)
	return _c
}
