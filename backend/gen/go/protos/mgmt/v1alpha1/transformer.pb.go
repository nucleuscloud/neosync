...
var file_mgmt_v1alpha1_transformer_proto_rawDesc = []byte{
	...
	0x64, 0x61, 0x74, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x39, 0x0a, 0x0b, 0x54, 0x72,
	...
	0x61, 0x6e, 0x73, 0x66, 0x6f, 0x72, 0x6d, 0x65, 0x72, 0x73, 0x32, 0x78, 0x0a, 0x12, 0x54, 0x72,
...
var file_mgmt_v1alpha1_transformer_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_mgmt_v1alpha1_transformer_proto_goTypes = []interface{}{
	(*Transformer)(nil),             // 0: mgmt.v1alpha1.Transformer
...
var file_mgmt_v1alpha1_transformer_proto_depIdxs = []int32{
	0, // 0: mgmt.v1alpha1.GetTransformersResponse.transformers:type_name -> mgmt.v1alpha1.Transformer
	1, // 1: mgmt.v1alpha1.TransformerService.GetTransformers:input_type -> mgmt.v1alpha1.GetTransformersRequest
	2, // 2: mgmt.v1alpha1.TransformerService.GetTransformers:output_type -> mgmt.v1alpha1.GetTransformersResponse
