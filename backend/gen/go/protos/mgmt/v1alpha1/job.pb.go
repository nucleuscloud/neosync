...
var file_mgmt_v1alpha1_job_proto_rawDesc = []byte{
	...
	0x45, 0x44, 0x10, 0x07, 0x32, 0xcf, 0x0d, 0x0a, 0x0a, 0x4a, 0x6f, 0x62, 0x53, 0x65, 0x72, 0x76,
...
var file_mgmt_v1alpha1_job_proto_depIdxs = []int32{
	...
	40, // 15: mgmt.v1alpha1.UpdateJobSourceConnectionResponse.job:type_name -> mgmt.v1alpha1.Job
	10, // 16: mgmt.v1alpha1.SetJobDestinationConnectionRequest.options:type_name -> mgmt.v1alpha1.JobDestinationOptions
	40, // 17: mgmt.v1alpha1.SetJobDestinationConnectionResponse.job:type_name -> mgmt.v1alpha1.Job
	6,  // 18: mgmt.v1alpha1.CreateJobDestinationConnectionsRequest.destinations:type_name -> mgmt.v1alpha1.JobDestination
	40, // 19: mgmt.v1alpha1.CreateJobDestinationConnectionsResponse.job:type_name -> mgmt.v1alpha1.Job
	43, // 20: mgmt.v1alpha1.GetJobRunsResponse.job_runs:type_name -> mgmt.v1alpha1.JobRun
	43, // 21: mgmt.v1alpha1.GetJobRunResponse.job_run:type_name -> mgmt.v1alpha1.JobRun
	43, // 22: mgmt.v1alpha1.CreateJobRunResponse.job_run:type_name -> mgmt.v1alpha1.JobRun
	52, // 23: mgmt.v1alpha1.Job.created_at:type_name -> google.protobuf.Timestamp
	52, // 24: mgmt.v1alpha1.Job.updated_at:type_name -> google.protobuf.Timestamp
	0,  // 25: mgmt.v1alpha1.Job.status:type_name -> mgmt.v1alpha1.JobStatus
	5,  // 26: mgmt.v1alpha1.Job.source:type_name -> mgmt.v1alpha1.JobSource
	6,  // 27: mgmt.v1alpha1.Job.destinations:type_name -> mgmt.v1alpha1.JobDestination
	15, // 28: mgmt.v1alpha1.Job.mappings:type_name -> mgmt.v1alpha1.JobMapping
	1,  // 29: mgmt.v1alpha1.PendingActivity.status:type_name -> mgmt.v1alpha1.ActivityStatus
	41, // 30: mgmt.v1alpha1.PendingActivity.last_failure:type_name -> mgmt.v1alpha1.ActivityFailure
	2,  // 31: mgmt.v1alpha1.JobRun.status:type_name -> mgmt.v1alpha1.JobRunStatus
	52, // 32: mgmt.v1alpha1.JobRun.started_at:type_name -> google.protobuf.Timestamp
	52, // 33: mgmt.v1alpha1.JobRun.completed_at:type_name -> google.protobuf.Timestamp
	42, // 34: mgmt.v1alpha1.JobRun.pending_activities:type_name -> mgmt.v1alpha1.PendingActivity
	52, // 35: mgmt.v1alpha1.JobRunEvent.created_at:type_name -> google.protobuf.Timestamp
	44, // 36: mgmt.v1alpha1.GetJobRunEventsResponse.events:type_name -> mgmt.v1alpha1.JobRunEvent
	47, // 37: mgmt.v1alpha1.GetTransformersResponse.transformers:type_name -> mgmt.v1alpha1.Transformer
	3,  // 38: mgmt.v1alpha1.JobService.GetJobs:input_type -> mgmt.v1alpha1.GetJobsRequest
	16, // 39: mgmt.v1alpha1.JobService.GetJob:input_type -> mgmt.v1alpha1.GetJobRequest
	13, // 40: mgmt.v1alpha1.JobService.CreateJob:input_type -> mgmt.v1alpha1.CreateJobRequest
	28, // 41: mgmt.v1alpha1.JobService.DeleteJob:input_type -> mgmt.v1alpha1.DeleteJobRequest
	30, // 42: mgmt.v1alpha1.JobService.IsJobNameAvailable:input_type -> mgmt.v1alpha1.IsJobNameAvailableRequest
	18, // 43: mgmt.v1alpha1.JobService.UpdateJobSchedule:input_type -> mgmt.v1alpha1.UpdateJobScheduleRequest
	20, // 44: mgmt.v1alpha1.JobService.UpdateJobSourceConnection:input_type -> mgmt.v1alpha1.UpdateJobSourceConnectionRequest
	22, // 45: mgmt.v1alpha1.JobService.SetJobDestinationConnection:input_type -> mgmt.v1alpha1.SetJobDestinationConnectionRequest
	24, // 46: mgmt.v1alpha1.JobService.DeleteJobDestinationConnection:input_type -> mgmt.v1alpha1.DeleteJobDestinationConnectionRequest
	26, // 47: mgmt.v1alpha1.JobService.CreateJobDestinationConnections:input_type -> mgmt.v1alpha1.CreateJobDestinationConnectionsRequest
	32, // 48: mgmt.v1alpha1.JobService.GetJobRuns:input_type -> mgmt.v1alpha1.GetJobRunsRequest
	45, // 49: mgmt.v1alpha1.JobService.GetJobRunEvents:input_type -> mgmt.v1alpha1.GetJobRunEventsRequest
	34, // 50: mgmt.v1alpha1.JobService.GetJobRun:input_type -> mgmt.v1alpha1.GetJobRunRequest
	50, // 51: mgmt.v1alpha1.JobService.DeleteJobRun:input_type -> mgmt.v1alpha1.DeleteJobRunRequest
	36, // 52: mgmt.v1alpha1.JobService.CreateJobRun:input_type -> mgmt.v1alpha1.CreateJobRunRequest
	38, // 53: mgmt.v1alpha1.JobService.CancelJobRun:input_type -> mgmt.v1alpha1.CancelJobRunRequest
	48, // 54: mgmt.v1alpha1.JobService.GetTransformers:input_type -> mgmt.v1alpha1.GetTransformersRequest
	4,  // 55: mgmt.v1alpha1.JobService.GetJobs:output_type -> mgmt.v1alpha1.GetJobsResponse
	17, // 56: mgmt.v1alpha1.JobService.GetJob:output_type -> mgmt.v1alpha1.GetJobResponse
	14, // 57: mgmt.v1alpha1.JobService.CreateJob:output_type -> mgmt.v1alpha1.CreateJobResponse
	29, // 58: mgmt.v1alpha1.JobService.DeleteJob:output_type -> mgmt.v1alpha1.DeleteJobResponse
	31, // 59: mgmt.v1alpha1.JobService.IsJobNameAvailable:output_type -> mgmt.v1alpha1.IsJobNameAvailableResponse
	19, // 60: mgmt.v1alpha1.JobService.UpdateJobSchedule:output_type -> mgmt.v1alpha1.UpdateJobScheduleResponse
	21, // 61: mgmt.v1alpha1.JobService.UpdateJobSourceConnection:output_type -> mgmt.v1alpha1.UpdateJobSourceConnectionResponse
	23, // 62: mgmt.v1alpha1.JobService.SetJobDestinationConnection:output_type -> mgmt.v1alpha1.SetJobDestinationConnectionResponse
	25, // 63: mgmt.v1alpha1.JobService.DeleteJobDestinationConnection:output_type -> mgmt.v1alpha1.DeleteJobDestinationConnectionResponse
	27, // 64: mgmt.v1alpha1.JobService.CreateJobDestinationConnections:output_type -> mgmt.v1alpha1.CreateJobDestinationConnectionsResponse
	33, // 65: mgmt.v1alpha1.JobService.GetJobRuns:output_type -> mgmt.v1alpha1.GetJobRunsResponse
	46, // 66: mgmt.v1alpha1.JobService.GetJobRunEvents:output_type -> mgmt.v1alpha1.GetJobRunEventsResponse
	35, // 67: mgmt.v1alpha1.JobService.GetJobRun:output_type -> mgmt.v1alpha1.GetJobRunResponse
	51, // 68: mgmt.v1alpha1.JobService.DeleteJobRun:output_type -> mgmt.v1alpha1.DeleteJobRunResponse
	37, // 69: mgmt.v1alpha1.JobService.CreateJobRun:output_type -> mgmt.v1alpha1.CreateJobRunResponse
	39, // 70: mgmt.v1alpha1.JobService.CancelJobRun:output_type -> mgmt.v1alpha1.CancelJobRunResponse
	49, // 71: mgmt.v1alpha1.JobService.GetTransformers:output_type -> mgmt.v1alpha1.GetTransformersResponse
