...
const (
	...
	AccountStatusReason_ACCOUNT_STATUS_REASON_REASON_UNSPECIFIED AccountStatusReason = 0
	// Current usage exceeds allowed limit
	AccountStatusReason_ACCOUNT_STATUS_REASON_EXCEEDS_ALLOWED_LIMIT AccountStatusReason = 1
	// Adding requested records exceeds the allowed limit
	AccountStatusReason_ACCOUNT_STATUS_REASON_REQUESTED_EXCEEDS_LIMIT AccountStatusReason = 2
	// Account is currently in an expired state
	AccountStatusReason_ACCOUNT_STATUS_REASON_ACCOUNT_IN_EXPIRED_STATE AccountStatusReason = 3
)

// Enum value maps for AccountStatusReason.
var (
	AccountStatusReason_name = map[int32]string{
		0: "ACCOUNT_STATUS_REASON_REASON_UNSPECIFIED",
		1: "ACCOUNT_STATUS_REASON_EXCEEDS_ALLOWED_LIMIT",
		2: "ACCOUNT_STATUS_REASON_REQUESTED_EXCEEDS_LIMIT",
		3: "ACCOUNT_STATUS_REASON_ACCOUNT_IN_EXPIRED_STATE",
	}
	AccountStatusReason_value = map[string]int32{
		"ACCOUNT_STATUS_REASON_REASON_UNSPECIFIED":       0,
		"ACCOUNT_STATUS_REASON_EXCEEDS_ALLOWED_LIMIT":    1,
		"ACCOUNT_STATUS_REASON_REQUESTED_EXCEEDS_LIMIT":  2,
		"ACCOUNT_STATUS_REASON_ACCOUNT_IN_EXPIRED_STATE": 3,
	}
)
...
type IsAccountStatusValidResponse struct {
	...
	InvalidReason *AccountStatusReason `protobuf:"varint,3,opt,name=invalid_reason,json=invalidReason,proto3,enum=mgmt.v1alpha1.AccountStatusReason,oneof" json:"invalid_reason,omitempty"`
	...
	ShouldPoll bool `protobuf:"varint,5,opt,name=should_poll,json=shouldPoll,proto3" json:"should_poll,omitempty"`
}
...
func (x *IsAccountStatusValidResponse) GetInvalidReason() AccountStatusReason {
	if x != nil && x.InvalidReason != nil {
		return *x.InvalidReason
	}
	return AccountStatusReason_ACCOUNT_STATUS_REASON_REASON_UNSPECIFIED
}

func (x *IsAccountStatusValidResponse) GetDescription() string {
...
var file_mgmt_v1alpha1_user_account_proto_rawDesc = []byte{
	...
	0x72, 0x64, 0x5f, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0x9c, 0x02, 0x0a, 0x1c, 0x49, 0x73, 0x41,
	...
	0x01, 0x12, 0x4e, 0x0a, 0x0e, 0x69, 0x6e, 0x76, 0x61, 0x6c, 0x69, 0x64, 0x5f, 0x72, 0x65, 0x61,
	0x73, 0x6f, 0x6e, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x22, 0x2e, 0x6d, 0x67, 0x6d, 0x74,
	0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x31, 0x2e, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e,
	0x74, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x48, 0x01, 0x52,
	0x0d, 0x69, 0x6e, 0x76, 0x61, 0x6c, 0x69, 0x64, 0x52, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x88, 0x01,
	...
	0x70, 0x74, 0x69, 0x6f, 0x6e, 0x88, 0x01, 0x01, 0x12, 0x1f, 0x0a, 0x0b, 0x73, 0x68, 0x6f, 0x75,
	0x6c, 0x64, 0x5f, 0x70, 0x6f, 0x6c, 0x6c, 0x18, 0x05, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0a, 0x73,
	0x68, 0x6f, 0x75, 0x6c, 0x64, 0x50, 0x6f, 0x6c, 0x6c, 0x42, 0x09, 0x0a, 0x07, 0x5f, 0x72, 0x65,
	0x61, 0x73, 0x6f, 0x6e, 0x42, 0x11, 0x0a, 0x0f, 0x5f, 0x69, 0x6e, 0x76, 0x61, 0x6c, 0x69, 0x64,
	0x5f, 0x72, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x42, 0x0e, 0x0a, 0x0c, 0x5f, 0x64, 0x65, 0x73, 0x63,
	0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x52, 0x0a, 0x27, 0x47, 0x65, 0x74, 0x41, 0x63,
	...
	0x76, 0x65, 0x6e, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x2a, 0x92, 0x01, 0x0a,
	...
	,
...
var file_mgmt_v1alpha1_user_account_proto_goTypes = []any{
	...
	(AccountStatusReason)(0),                         // 2: mgmt.v1alpha1.AccountStatusReason
...
var file_mgmt_v1alpha1_user_account_proto_depIdxs = []int32{
	...
	2,  // 17: mgmt.v1alpha1.IsAccountStatusValidResponse.invalid_reason:type_name -> mgmt.v1alpha1.AccountStatusReason
