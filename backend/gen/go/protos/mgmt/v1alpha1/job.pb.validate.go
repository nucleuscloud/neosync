...
// Validate checks the field values on GetLatestJobRunRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *GetLatestJobRunRequest) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on GetLatestJobRunRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// GetLatestJobRunRequestMultiError, or nil if none found.
func (m *GetLatestJobRunRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *GetLatestJobRunRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return GetLatestJobRunRequestMultiError(errors)
	}

	return nil
}

// GetLatestJobRunRequestMultiError is an error wrapping multiple validation
// errors returned by GetLatestJobRunRequest.ValidateAll() if the designated
// constraints aren't met.
type GetLatestJobRunRequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m GetLatestJobRunRequestMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m GetLatestJobRunRequestMultiError) AllErrors() []error { return m }

// GetLatestJobRunRequestValidationError is the validation error returned by
// GetLatestJobRunRequest.Validate if the designated constraints aren't met.
type GetLatestJobRunRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e GetLatestJobRunRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e GetLatestJobRunRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e GetLatestJobRunRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e GetLatestJobRunRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e GetLatestJobRunRequestValidationError) ErrorName() string {
	return "GetLatestJobRunRequestValidationError"
}

// Error satisfies the builtin error interface
func (e GetLatestJobRunRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sGetLatestJobRunRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = GetLatestJobRunRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = GetLatestJobRunRequestValidationError{}

// Validate checks the field values on GetLatestJobRunResponse with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *GetLatestJobRunResponse) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on GetLatestJobRunResponse with the
// rules defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// GetLatestJobRunResponseMultiError, or nil if none found.
func (m *GetLatestJobRunResponse) ValidateAll() error {
	return m.validate(true)
}

func (m *GetLatestJobRunResponse) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if all {
		...
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, GetLatestJobRunResponseValidationError{
					field:  "JobRun",
					reason: "embedded message failed validation",
					cause:  err,
				})
		...
		if err := v.Validate(); err != nil {
			return GetLatestJobRunResponseValidationError{
				field:  "JobRun",
				reason: "embedded message failed validation",
				cause:  err,
			}
	...
	if len(errors) > 0 {
		return GetLatestJobRunResponseMultiError(errors)
	}

	return nil
}

// GetLatestJobRunResponseMultiError is an error wrapping multiple validation
// errors returned by GetLatestJobRunResponse.ValidateAll() if the designated
// constraints aren't met.
type GetLatestJobRunResponseMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m GetLatestJobRunResponseMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m GetLatestJobRunResponseMultiError) AllErrors() []error { return m }

// GetLatestJobRunResponseValidationError is the validation error returned by
// GetLatestJobRunResponse.Validate if the designated constraints aren't met.
type GetLatestJobRunResponseValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e GetLatestJobRunResponseValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e GetLatestJobRunResponseValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e GetLatestJobRunResponseValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e GetLatestJobRunResponseValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e GetLatestJobRunResponseValidationError) ErrorName() string {
	return "GetLatestJobRunResponseValidationError"
}

// Error satisfies the builtin error interface
func (e GetLatestJobRunResponseValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sGetLatestJobRunResponse.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = GetLatestJobRunResponseValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = GetLatestJobRunResponseValidationError{}
