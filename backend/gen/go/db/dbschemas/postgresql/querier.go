...
type Querier interface {
	...
	GetCompositeTypesByTables(ctx context.Context, db DBTX, arg *GetCompositeTypesByTablesParams) ([]*GetCompositeTypesByTablesRow, error)
	...
	GetDomainsByTables(ctx context.Context, db DBTX, arg *GetDomainsByTablesParams) ([]*GetDomainsByTablesRow, error)
	GetEnumTypesByTables(ctx context.Context, db DBTX, arg *GetEnumTypesByTablesParams) ([]*GetEnumTypesByTablesRow, error)
