...
<ProtoMessage key={79} message={{"name":"JobHookTimingPreSync","longName":"JobHookTimingPreSync","fullName":"mgmt.v1alpha1.JobHookTimingPreSync","description":"Configures the job hook to run before the first table sync.","hasExtensions":false,"hasFields":false,"hasOneofs":false,"extensions":[],"fields":[]}} />
