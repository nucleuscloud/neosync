...
Neosync provides the core anonymization functionality through [transformers](/platform#transformers). Transformers anonymize or mask source data in any way you'd like. Neosync ships with a number of pre-built transformers to help you get started or you can write your own user defined transformer. For ex. say that you have a users table with the following columns:
...
![anon](https://assets.nucleuscloud.com/neosync/docs/pii-anon.png)
...
![anon-table](https://assets.nucleuscloud.com/neosync/docs/pii-anon-table.png)

Since the transformers are customizable, you can anonymize or mask any source data by writing your own user defined transformer. Check out the [user defined transformers](/transformers/user-defined) guide for more information. This gives you ultimate flexibility to control your data.
