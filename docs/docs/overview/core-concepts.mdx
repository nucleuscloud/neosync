...
<OrderedListComponent
  items={[
    'Sync Jobs - Replicate and anonymize data between a source and a destination such as two databases.',
    'Generation Jobs - Generate synthetic data and sync it to a destination such a database or S3.',
  ]}
/>
...
<DocsImage href="https://assets.nucleuscloud.com/neosync/docs/runs-page.png" />
...
<DocsImage href="https://assets.nucleuscloud.com/neosync/docs/connections-page.png" />
