...
| Name            | Description                                                                                                              | Default | Example Output |
| --------------- | ------------------------------------------------------------------------------------------------------------------------ | ------- | -------------- |
| Include hyphens | Includes hyphens in the output phone number. Note that this config can only be used with default 10 digit phone numbers. | false   | 290-374-8675   |
