...
There are three discrete services in Neosync, and each one has its own purpose. See the architecture section of the docs to understand more about the makeup of Neosync.
