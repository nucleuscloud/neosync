...
func (_m *MockConnectionProvider[T]) GetConnectionDetails(connectionConfig *mgmtv1alpha1.ConnectionConfig, connectionTimeout *uint32, logger *slog.Logger) (ConnectionDetails, error) {
...
type MockConnectionProvider_GetConnectionDetails_Call[T any] struct {
	*mock.Call
}
...
//   - logger *slog.Logger
func (_e *MockConnectionProvider_Expecter[T]) GetConnectionDetails(connectionConfig interface{}, connectionTimeout interface{}, logger interface{}) *MockConnectionProvider_GetConnectionDetails_Call[T] {
	return &MockConnectionProvider_GetConnectionDetails_Call[T]{Call: _e.mock.On("GetConnectionDetails", connectionConfig, connectionTimeout, logger)}
}

func (_c *MockConnectionProvider_GetConnectionDetails_Call[T]) Run(run func(connectionConfig *mgmtv1alpha1.ConnectionConfig, connectionTimeout *uint32, logger *slog.Logger)) *MockConnectionProvider_GetConnectionDetails_Call[T] {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockConnectionProvider_GetConnectionDetails_Call[T]) Return(_a0 ConnectionDetails, _a1 error) *MockConnectionProvider_GetConnectionDetails_Call[T] {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockConnectionProvider_GetConnectionDetails_Call[T]) RunAndReturn(run func(*mgmtv1alpha1.ConnectionConfig, *uint32, *slog.Logger) (ConnectionDetails, error)) *MockConnectionProvider_GetConnectionDetails_Call[T] {
	_c.Call.Return(run)
	return _c
}
