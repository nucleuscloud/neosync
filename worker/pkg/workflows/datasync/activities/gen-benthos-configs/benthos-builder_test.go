...
func Test_BenthosBuilder_GenerateBenthosConfigs_PrimaryKey_Transformer_Pg_Pg(t *testing.T) {
	...
	mockSqlManager.On("NewPooledSqlDb", mock.Anything, mock.Anything, mock.Anything).Return(&sqlmanager.SqlConnection{Db: mockSqlDb, Driver: sqlmanager_shared.PostgresDriver}, nil)
	mockSqlDb.On("Close").Return(nil)
	mockSqlDb.On("GetSchemaColumnMap", mock.Anything).Return(map[string]map[string]*sqlmanager_shared.ColumnInfo{
	...
	mockSqlDb.On("GetTableConstraintsBySchema", mock.Anything, []string{"public"}).Return(&sqlmanager_shared.TableConstraints{
		ForeignKeyConstraints: map[string][]*sqlmanager_shared.ForeignConstraint{"public.orders": {{Columns: []string{"buyer_id"}, NotNullable: []bool{true}, ForeignKey: &sqlmanager_shared.ForeignKey{Table: "public.users", Columns: []string{"id"}}}}},
...
func Test_BenthosBuilder_GenerateBenthosConfigs_CircularDependency_PrimaryKey_Transformer_Pg_Pg(t *testing.T) {
	...
	mockSqlDb.On("Close").Return(nil)
	mockSqlDb.On("GetSchemaColumnMap", mock.Anything).Return(map[string]map[string]*sqlmanager_shared.ColumnInfo{
		"public.jobs": {"id": &sqlmanager_shared.ColumnInfo{}, "parent_id": &sqlmanager_shared.ColumnInfo{}},
	}, nil)
	mockSqlDb.On("GetTableConstraintsBySchema", mock.Anything, []string{"public"}).Return(&sqlmanager_shared.TableConstraints{
		ForeignKeyConstraints: map[string][]*sqlmanager_shared.ForeignConstraint{"public.jobs": {{Columns: []string{"parent_id"}, NotNullable: []bool{false}, ForeignKey: &sqlmanager_shared.ForeignKey{Table: "public.jobs", Columns: []string{"id"}}}}},
...
func Test_BenthosBuilder_GenerateBenthosConfigs_Basic_Pg_Pg_With_Constraints(t *testing.T) {
	...
	mockSqlDb.On("GetSchemaColumnMap", mock.Anything).Return(map[string]map[string]*sqlmanager_shared.ColumnInfo{
		"public.users":                     {"id": &sqlmanager_shared.ColumnInfo{}, "name": &sqlmanager_shared.ColumnInfo{}},
		"public.user_account_associations": {"id": &sqlmanager_shared.ColumnInfo{}, "user_id": &sqlmanager_shared.ColumnInfo{}},
	}, nil)
	mockSqlDb.On("GetTableConstraintsBySchema", mock.Anything, []string{"public"}).Return(&sqlmanager_shared.TableConstraints{
		ForeignKeyConstraints: map[string][]*sqlmanager_shared.ForeignConstraint{"public.user_account_associations": {{Columns: []string{"user_id"}, NotNullable: []bool{true}, ForeignKey: &sqlmanager_shared.ForeignKey{Table: "public.users", Columns: []string{"id"}}}}},
		PrimaryKeyConstraints: map[string][]string{
			"public.users":                     {"id"},
...
func Test_BenthosBuilder_GenerateBenthosConfigs_Basic_Pg_Pg_With_Circular_Dependency(t *testing.T) {
	...
	mockSqlDb.On("Close").Return(nil)
	mockSqlDb.On("GetSchemaColumnMap", mock.Anything).Return(map[string]map[string]*sqlmanager_shared.ColumnInfo{
		"public.users":                     {"id": &sqlmanager_shared.ColumnInfo{}, "user_assoc_id": &sqlmanager_shared.ColumnInfo{}, "name": &sqlmanager_shared.ColumnInfo{}},
		"public.user_account_associations": {"id": &sqlmanager_shared.ColumnInfo{}, "user_id": &sqlmanager_shared.ColumnInfo{}},
	}, nil)
	mockSqlDb.On("GetTableConstraintsBySchema", mock.Anything, []string{"public"}).Return(&sqlmanager_shared.TableConstraints{
		ForeignKeyConstraints: map[string][]*sqlmanager_shared.ForeignConstraint{
			...
			"public.users":                     {{Columns: []string{"user_assoc_id"}, NotNullable: []bool{false}, ForeignKey: &sqlmanager_shared.ForeignKey{Table: "public.user_account_associations", Columns: []string{"id"}}}},
		},
		PrimaryKeyConstraints: map[string][]string{
			"public.users":                     {"id"},
			"public.user_account_associations": {"id"},
...
func Test_BenthosBuilder_GenerateBenthosConfigs_Basic_Mysql_Mysql(t *testing.T) {
	...
	mockSqlManager.On("NewPooledSqlDb", mock.Anything, mock.Anything, mock.Anything).Return(&sqlmanager.SqlConnection{Db: mockSqlDb, Driver: sqlmanager_shared.MysqlDriver}, nil)
	mockSqlDb.On("Close").Return(nil)
	mockSqlDb.On("GetSchemaColumnMap", mock.Anything).Return(map[string]map[string]*sqlmanager_shared.ColumnInfo{
		"public.users":                     {"id": &sqlmanager_shared.ColumnInfo{}, "name": &sqlmanager_shared.ColumnInfo{}},
		"public.user_account_associations": {"id": &sqlmanager_shared.ColumnInfo{}, "user_id": &sqlmanager_shared.ColumnInfo{}},
...
func Test_ProcessorConfigMultiJavascript(t *testing.T) {
	...
	runconfigs := []*tabledependency.RunConfig{
		{Table: "public.users", RunType: tabledependency.RunTypeInsert, PrimaryKeys: []string{"id"}, InsertColumns: []string{"id", "name", "first_name"}, SelectColumns: []string{"id", "name", "first_name"}, DependsOn: []*tabledependency.DependsOn{}},
	}
...
func Test_ProcessorConfigMutationAndJavascript(t *testing.T) {
	...
	groupedSchemas := map[string]map[string]*sqlmanager_shared.ColumnInfo{
		"public.users": {
			"email": &sqlmanager_shared.ColumnInfo{
				OrdinalPosition:        2,
				ColumnDefault:          "",
				IsNullable:             true,
	...
	runconfigs := []*tabledependency.RunConfig{
		{Table: "public.users", RunType: tabledependency.RunTypeInsert, PrimaryKeys: []string{"id"}, InsertColumns: []string{"email", "first_name"}, SelectColumns: []string{"email", "first_name"}, DependsOn: []*tabledependency.DependsOn{}},
	}
...
func Test_buildProcessorConfigsJavascript(t *testing.T) {
	...
	res, err := buildProcessorConfigs(ctx, mockTransformerClient, []*mgmtv1alpha1.JobMapping{
		{Schema: "public", Table: "users", Column: "address", Transformer: &mgmtv1alpha1.JobMappingTransformer{Source: jsT.Source, Config: jsT.Config}}}, map[string]*sqlmanager_shared.ColumnInfo{}, map[string][]*referenceKey{}, []string{}, mockJobId, mockRunId, nil, &tabledependency.RunConfig{InsertColumns: []string{"address"}})
...
func Test_buildProcessorConfigsGenerateJavascript(t *testing.T) {
	...
	res, err := buildProcessorConfigs(ctx, mockTransformerClient, []*mgmtv1alpha1.JobMapping{
		{Schema: "public", Table: "users", Column: "test", Transformer: &mgmtv1alpha1.JobMappingTransformer{Source: jsT.Source, Config: jsT.Config}}}, map[string]*sqlmanager_shared.ColumnInfo{}, map[string][]*referenceKey{}, []string{}, mockJobId, mockRunId, nil, &tabledependency.RunConfig{InsertColumns: []string{"test"}})
...
func Test_buildProcessorConfigsJavascriptMultiLineScript(t *testing.T) {
  ...
  return payload;`
	...
	res, err := buildProcessorConfigs(ctx, mockTransformerClient, []*mgmtv1alpha1.JobMapping{
		{Schema: "public", Table: "users", Column: nameCol, Transformer: &mgmtv1alpha1.JobMappingTransformer{Source: jsT.Source, Config: jsT.Config}}}, map[string]*sqlmanager_shared.ColumnInfo{}, map[string][]*referenceKey{}, []string{}, mockJobId, mockRunId, nil, &tabledependency.RunConfig{InsertColumns: []string{nameCol}})
...
func Test_buildProcessorConfigsJavascriptMultiple(t *testing.T) {
	...
	res, err := buildProcessorConfigs(ctx, mockTransformerClient, []*mgmtv1alpha1.JobMapping{
		...
		{Schema: "public", Table: "users", Column: col2, Transformer: &mgmtv1alpha1.JobMappingTransformer{Source: jsT2.Source, Config: jsT2.Config}}}, map[string]*sqlmanager_shared.ColumnInfo{}, map[string][]*referenceKey{}, []string{}, mockJobId, mockRunId, nil, &tabledependency.RunConfig{InsertColumns: []string{nameCol, col2}})
