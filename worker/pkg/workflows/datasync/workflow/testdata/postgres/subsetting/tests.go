	...
	return []*workflow_testdata.IntegrationTest{
		{
			...
			Expected: map[string]*workflow_testdata.ExpectedOutput{
				...
				"subsetting.clients":               &workflow_testdata.ExpectedOutput{RowCount: 9},
				"subsetting.titles":                &workflow_testdata.ExpectedOutput{RowCount: 2},
				"subsetting.client_account_titles": &workflow_testdata.ExpectedOutput{RowCount: 3},
			},
		},
	}
}
