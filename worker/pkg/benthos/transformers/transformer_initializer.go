...
func InitializeTransformer(transformerMapping *mgmtv1alpha1.JobMappingTransformer) (*TransformerExecutor, error) {
	return InitializeTransformerExecutorByConfigType(transformerMapping.GetConfig())
}

func InitializeTransformerExecutorByConfigType(transformerConfig *mgmtv1alpha1.TransformerConfig) (*TransformerExecutor, error) {
