...
func BuildSelectQueryMap(
	...
	// 	})
	// }
	// qb := NewQueryBuilderFromSchemaDefinition(groupedColumnInfo, "public", driver, subsetByForeignKeyConstraints, pageLimit)

	qb := NewQueryBuilder("public", driver, subsetByForeignKeyConstraints, groupedColumnInfo, pageLimit)
