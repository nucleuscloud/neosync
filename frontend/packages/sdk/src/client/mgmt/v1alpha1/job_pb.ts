...
export type PostgresSourceConnectionOptions_ColumnRemovalStrategy = Message<"mgmt.v1alpha1.PostgresSourceConnectionOptions.ColumnRemovalStrategy"> & {
  ...
  strategy: {
     ...
     *
     * @generated from field: mgmt.v1alpha1.PostgresSourceConnectionOptions.ColumnRemovalStrategy.Auto auto = 2;
     */
    value: PostgresSourceConnectionOptions_ColumnRemovalStrategy_Auto;
    case: "auto";
  } | { case: undefined; value?: undefined };
};
 ...
 *
 * @generated from message mgmt.v1alpha1.PostgresSourceConnectionOptions.ColumnRemovalStrategy.Auto
 */
export type PostgresSourceConnectionOptions_ColumnRemovalStrategy_Auto = Message<"mgmt.v1alpha1.PostgresSourceConnectionOptions.ColumnRemovalStrategy.Auto"> & {
};

/**
 * Describes the message mgmt.v1alpha1.PostgresSourceConnectionOptions.ColumnRemovalStrategy.Auto.
 * Use `create(PostgresSourceConnectionOptions_ColumnRemovalStrategy_AutoSchema)` to create a new message.
 */
export const PostgresSourceConnectionOptions_ColumnRemovalStrategy_AutoSchema: GenMessage<PostgresSourceConnectionOptions_ColumnRemovalStrategy_Auto> = /*@__PURE__*/
...
export type MysqlSourceConnectionOptions_ColumnRemovalStrategy = Message<"mgmt.v1alpha1.MysqlSourceConnectionOptions.ColumnRemovalStrategy"> & {
  ...
  strategy: {
     ...
     * ignores removed columns.
     *
     * @generated from field: mgmt.v1alpha1.MysqlSourceConnectionOptions.ColumnRemovalStrategy.Auto auto = 2;
     */
    value: MysqlSourceConnectionOptions_ColumnRemovalStrategy_Auto;
    case: "auto";
  } | { case: undefined; value?: undefined };
};
 ...
 * Configuration for the AutoMap strategy
 *
 * @generated from message mgmt.v1alpha1.MysqlSourceConnectionOptions.ColumnRemovalStrategy.Auto
 */
export type MysqlSourceConnectionOptions_ColumnRemovalStrategy_Auto = Message<"mgmt.v1alpha1.MysqlSourceConnectionOptions.ColumnRemovalStrategy.Auto"> & {
};

/**
 * Describes the message mgmt.v1alpha1.MysqlSourceConnectionOptions.ColumnRemovalStrategy.Auto.
 * Use `create(MysqlSourceConnectionOptions_ColumnRemovalStrategy_AutoSchema)` to create a new message.
 */
export const MysqlSourceConnectionOptions_ColumnRemovalStrategy_AutoSchema: GenMessage<MysqlSourceConnectionOptions_ColumnRemovalStrategy_Auto> = /*@__PURE__*/
...
export type MssqlSourceConnectionOptions_ColumnRemovalStrategy = Message<"mgmt.v1alpha1.MssqlSourceConnectionOptions.ColumnRemovalStrategy"> & {
  ...
  strategy: {
     ...
     * ignores removed columns.
     *
     * @generated from field: mgmt.v1alpha1.MssqlSourceConnectionOptions.ColumnRemovalStrategy.Auto auto = 2;
     */
    value: MssqlSourceConnectionOptions_ColumnRemovalStrategy_Auto;
    case: "auto";
  } | { case: undefined; value?: undefined };
};
 ...
 * Configuration for the Auto strategy
 *
 * @generated from message mgmt.v1alpha1.MssqlSourceConnectionOptions.ColumnRemovalStrategy.Auto
 */
export type MssqlSourceConnectionOptions_ColumnRemovalStrategy_Auto = Message<"mgmt.v1alpha1.MssqlSourceConnectionOptions.ColumnRemovalStrategy.Auto"> & {
};

/**
 * Describes the message mgmt.v1alpha1.MssqlSourceConnectionOptions.ColumnRemovalStrategy.Auto.
 * Use `create(MssqlSourceConnectionOptions_ColumnRemovalStrategy_AutoSchema)` to create a new message.
 */
export const MssqlSourceConnectionOptions_ColumnRemovalStrategy_AutoSchema: GenMessage<MssqlSourceConnectionOptions_ColumnRemovalStrategy_Auto> = /*@__PURE__*/
