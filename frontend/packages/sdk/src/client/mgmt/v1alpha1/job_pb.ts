...
export type JobTypeConfig_JobTypeSync_ColumnStrategy_MapAllColumns = Message<"mgmt.v1alpha1.JobTypeConfig.JobTypeSync.ColumnStrategy.MapAllColumns"> & {
   ...
   *
   * @generated from field: optional mgmt.v1alpha1.JobTypeConfig.JobTypeSync.ColumnStrategy.MapAllColumns.NewColumnAdditionStrategy new_column_addition_strategy = 1;
   */
  newColumnAdditionStrategy?: JobTypeConfig_JobTypeSync_ColumnStrategy_MapAllColumns_NewColumnAdditionStrategy;
 ...
 *
 * @generated from message mgmt.v1alpha1.JobTypeConfig.JobTypeSync.ColumnStrategy.MapAllColumns.NewColumnAdditionStrategy
 */
export type JobTypeConfig_JobTypeSync_ColumnStrategy_MapAllColumns_NewColumnAdditionStrategy = Message<"mgmt.v1alpha1.JobTypeConfig.JobTypeSync.ColumnStrategy.MapAllColumns.NewColumnAdditionStrategy"> & {
  /**
   * @generated from oneof mgmt.v1alpha1.JobTypeConfig.JobTypeSync.ColumnStrategy.MapAllColumns.NewColumnAdditionStrategy.strategy
   */
  strategy: {
    /**
     * halt job if a new column is detected.
     *
     * @generated from field: mgmt.v1alpha1.JobTypeConfig.JobTypeSync.ColumnStrategy.MapAllColumns.NewColumnAdditionStrategy.HaltJob halt_job = 1;
     */
    value: JobTypeConfig_JobTypeSync_ColumnStrategy_MapAllColumns_NewColumnAdditionStrategy_HaltJob;
    case: "haltJob";
  } | {
    /**
     * automatically handle unmapped columns. It handles this by using the DBs default/nullable values.
     ...
     * If none of the criteria above can be met, the job run will fail to prevent leaking of PII.
     *
     * @generated from field: mgmt.v1alpha1.JobTypeConfig.JobTypeSync.ColumnStrategy.MapAllColumns.NewColumnAdditionStrategy.AutoMap auto_map = 2;
     */
    value: JobTypeConfig_JobTypeSync_ColumnStrategy_MapAllColumns_NewColumnAdditionStrategy_AutoMap;
    case: "autoMap";
  } | { case: undefined; value?: undefined };
};

/**
 * Describes the message mgmt.v1alpha1.JobTypeConfig.JobTypeSync.ColumnStrategy.MapAllColumns.NewColumnAdditionStrategy.
 * Use `create(JobTypeConfig_JobTypeSync_ColumnStrategy_MapAllColumns_NewColumnAdditionStrategySchema)` to create a new message.
 */
export const JobTypeConfig_JobTypeSync_ColumnStrategy_MapAllColumns_NewColumnAdditionStrategySchema: GenMessage<JobTypeConfig_JobTypeSync_ColumnStrategy_MapAllColumns_NewColumnAdditionStrategy> = /*@__PURE__*/
  messageDesc(file_mgmt_v1alpha1_job, 43, 0, 3, 0, 0);

/**
 * Configuration for the HaltJob strategy
 *
 * @generated from message mgmt.v1alpha1.JobTypeConfig.JobTypeSync.ColumnStrategy.MapAllColumns.NewColumnAdditionStrategy.HaltJob
 */
export type JobTypeConfig_JobTypeSync_ColumnStrategy_MapAllColumns_NewColumnAdditionStrategy_HaltJob = Message<"mgmt.v1alpha1.JobTypeConfig.JobTypeSync.ColumnStrategy.MapAllColumns.NewColumnAdditionStrategy.HaltJob"> & {
};

/**
 * Describes the message mgmt.v1alpha1.JobTypeConfig.JobTypeSync.ColumnStrategy.MapAllColumns.NewColumnAdditionStrategy.HaltJob.
 * Use `create(JobTypeConfig_JobTypeSync_ColumnStrategy_MapAllColumns_NewColumnAdditionStrategy_HaltJobSchema)` to create a new message.
 */
export const JobTypeConfig_JobTypeSync_ColumnStrategy_MapAllColumns_NewColumnAdditionStrategy_HaltJobSchema: GenMessage<JobTypeConfig_JobTypeSync_ColumnStrategy_MapAllColumns_NewColumnAdditionStrategy_HaltJob> = /*@__PURE__*/
  messageDesc(file_mgmt_v1alpha1_job, 43, 0, 3, 0, 0, 0);

/**
 * Configuration for the AutoMap strategy
 *
 * @generated from message mgmt.v1alpha1.JobTypeConfig.JobTypeSync.ColumnStrategy.MapAllColumns.NewColumnAdditionStrategy.AutoMap
 */
export type JobTypeConfig_JobTypeSync_ColumnStrategy_MapAllColumns_NewColumnAdditionStrategy_AutoMap = Message<"mgmt.v1alpha1.JobTypeConfig.JobTypeSync.ColumnStrategy.MapAllColumns.NewColumnAdditionStrategy.AutoMap"> & {
};

/**
 * Describes the message mgmt.v1alpha1.JobTypeConfig.JobTypeSync.ColumnStrategy.MapAllColumns.NewColumnAdditionStrategy.AutoMap.
 * Use `create(JobTypeConfig_JobTypeSync_ColumnStrategy_MapAllColumns_NewColumnAdditionStrategy_AutoMapSchema)` to create a new message.
 */
export const JobTypeConfig_JobTypeSync_ColumnStrategy_MapAllColumns_NewColumnAdditionStrategy_AutoMapSchema: GenMessage<JobTypeConfig_JobTypeSync_ColumnStrategy_MapAllColumns_NewColumnAdditionStrategy_AutoMap> = /*@__PURE__*/
...
export type JobTypeConfig_JobTypeSync_ColumnStrategy_MapAllColumns_ColumnRemovalStrategy = Message<"mgmt.v1alpha1.JobTypeConfig.JobTypeSync.ColumnStrategy.MapAllColumns.ColumnRemovalStrategy"> & {
  ...
  strategy: {
     ...
     * halt job if a column is removed
     *
     * @generated from field: mgmt.v1alpha1.JobTypeConfig.JobTypeSync.ColumnStrategy.MapAllColumns.ColumnRemovalStrategy.HaltJob halt_job = 1;
     */
     ...
     * continue job if a column is removed
     *
     * @generated from field: mgmt.v1alpha1.JobTypeConfig.JobTypeSync.ColumnStrategy.MapAllColumns.ColumnRemovalStrategy.ContinueJob continue_job = 2;
     */
