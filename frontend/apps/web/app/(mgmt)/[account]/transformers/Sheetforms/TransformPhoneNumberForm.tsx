...
interface Props extends TransformerFormProps<TransformPhoneNumber> {}
...
export default function TransformStringPhoneNumberForm(
  ...
  const form = useForm({
    ...
    resolver: yupResolver(
      TRANSFORMER_SCHEMA_CONFIGS.transformPhoneNumberConfig
    ),
    defaultValues: {
            ...
            <FormItem className="flex flex-row items-center justify-between rounded-lg border p-3 shadow-sm">
              <div className="space-y-0.5">
                ...
                <FormDescription className="w-[90%]">
                  Set the length of the output phone number to be the same as
                  the input
                </FormDescription>
              </div>
              <FormControl>
