...
declare namespace neosync {
   ...
   */
  declare function transformCharacterScramble(
    value: any,
    options: TransformCharacterScrambleOptions
  ): any;
   ...
   */
  declare function transformE164PhoneNumber(
    value: any,
    options: TransformE164PhoneNumberOptions
  ): any;
   ...
   */
  declare function transformEmail(
    value: any,
   ...
   */
  declare function transformFirstName(
    value: any,
    options: TransformFirstNameOptions
  ): any;
   ...
   */
  declare function transformFloat64(
    value: any,
    options: TransformFloat64Options
  ): any;
   ...
   */
  declare function transformFullName(
    value: any,
    options: TransformFullNameOptions
  ): any;
   ...
   */
  declare function transformInt64(
    value: any,
    options: TransformInt64Options
  ): any;
   ...
   */
  declare function transformInt64PhoneNumber(
    value: any,
    options: TransformInt64PhoneNumberOptions
  ): any;
   ...
   */
  declare function transformLastName(
    value: any,
    options: TransformLastNameOptions
  ): any;
   ...
   */
  declare function transformString(
    value: any,
   ...
   */
  declare function transformStringPhoneNumber(
    value: any,
    options: TransformStringPhoneNumberOptions
  ): any;
   ...
   */
  declare function generateCategorical(
    options: GenerateCategoricalOptions
  ): any;
   ...
   */
  declare function generateFullAddress(
    options: GenerateFullAddressOptions
  ): any;
   ...
   */
  declare function generateInt64PhoneNumber(
    options: GenerateInt64PhoneNumberOptions
  ): any;
   ...
   */
  declare function generateInternationalPhoneNumber(
    options: GenerateInternationalPhoneNumberOptions
  ): any;
   ...
   * Randomly generates a street address.
   */
  declare function generateStreetAddress(
    options: GenerateStreetAddressOptions
  ): any;
   ...
   */
  declare function generateStringPhoneNumber(
    options: GenerateStringPhoneNumberOptions
  ): any;
   ...
   */
  declare function generateUnixTimestamp(
    options: GenerateUnixTimestampOptions
  ): any;
   ...
   */
  declare function generateUTCTimestamp(
    options: GenerateUTCTimestampOptions
  ): any;
