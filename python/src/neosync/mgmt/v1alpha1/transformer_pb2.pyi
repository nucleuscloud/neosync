...
class TransformerSource(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    ...
    TRANSFORMER_SOURCE_TRANSFORM_HASH: _ClassVar[TransformerSource]
...
TRANSFORMER_SOURCE_TRANSFORM_HASH: TransformerSource
...
class TransformerConfig(_message.Message):
    ...
    TRANSFORM_UUID_CONFIG_FIELD_NUMBER: _ClassVar[int]
    TRANSFORM_HASH_CONFIG_FIELD_NUMBER: _ClassVar[int]
...
class TransformUuid(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class TransformHash(_message.Message):
    __slots__ = ("algo",)
    class HashType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = ()
        HASH_TYPE_UNSPECIFIED: _ClassVar[TransformHash.HashType]
        HASH_TYPE_MD5: _ClassVar[TransformHash.HashType]
        HASH_TYPE_SHA1: _ClassVar[TransformHash.HashType]
        HASH_TYPE_SHA256: _ClassVar[TransformHash.HashType]
        HASH_TYPE_SHA512: _ClassVar[TransformHash.HashType]
    HASH_TYPE_UNSPECIFIED: TransformHash.HashType
    HASH_TYPE_MD5: TransformHash.HashType
    HASH_TYPE_SHA1: TransformHash.HashType
    HASH_TYPE_SHA256: TransformHash.HashType
    HASH_TYPE_SHA512: TransformHash.HashType
    ALGO_FIELD_NUMBER: _ClassVar[int]
    algo: TransformHash.HashType
    def __init__(self, algo: _Optional[_Union[TransformHash.HashType, str]] = ...) -> None: ...
