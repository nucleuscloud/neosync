...
class TransformPiiText(_message.Message):
    __slots__ = ("score_threshold", "default_anonymizer", "deny_recognizers")
    ...
    def __init__(self, score_threshold: _Optional[float] = ..., default_anonymizer: _Optional[_Union[PiiAnonymizer, _Mapping]] = ..., deny_recognizers: _Optional[_Iterable[_Union[PiiDenyRecognizer, _Mapping]]] = ...) -> None: ...
