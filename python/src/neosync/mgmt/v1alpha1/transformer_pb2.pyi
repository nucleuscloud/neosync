...
class TransformPiiText(_message.Message):
    ...
    ALLOWED_RECOGNIZERS_FIELD_NUMBER: _ClassVar[int]
    score_threshold: float
    default_anonymizer: PiiAnonymizer
    deny_recognizers: _containers.RepeatedCompositeFieldContainer[PiiDenyRecognizer]
    allowed_recognizers: _containers.RepeatedScalarFieldContainer[str]
    def __init__(self, score_threshold: _Optional[float] = ..., default_anonymizer: _Optional[_Union[PiiAnonymizer, _Mapping]] = ..., deny_recognizers: _Optional[_Iterable[_Union[PiiDenyRecognizer, _Mapping]]] = ..., allowed_recognizers: _Optional[_Iterable[str]] = ...) -> None: ...
...
class GetTransformPiiRecognizersRequest(_message.Message):
    __slots__ = ("account_id",)
    ACCOUNT_ID_FIELD_NUMBER: _ClassVar[int]
    account_id: str
    def __init__(self, account_id: _Optional[str] = ...) -> None: ...

class GetTransformPiiRecognizersResponse(_message.Message):
    __slots__ = ("recognizers",)
    RECOGNIZERS_FIELD_NUMBER: _ClassVar[int]
    recognizers: _containers.RepeatedScalarFieldContainer[str]
    def __init__(self, recognizers: _Optional[_Iterable[str]] = ...) -> None: ...
