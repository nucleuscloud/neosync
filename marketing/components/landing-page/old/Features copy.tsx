...
export default function FeaturesCopy(): ReactElement {
  const features = [
    {
      title: 'Orchestration',
      description:
  ...
  return (
    <div className="bg-[#F5F5F5]">
      <div className="pt-5 lg:pt-40 px-5 sm:px-10 md:px-20 lg:px-40 max-w-[1800px] mx-auto ">
        <div className="bg-gradient-to-tr from-[#0F0F0F] to-[#2e2e2e] rounded-xl p-8 shadow-xl ">
          <div className=" flex flex-col px-6">
            <div className="text-gray-100 font-semibold text-2xl lg:text-4xl font-satoshi text-center">
              Built for Security and Scalability
            </div>
            <div className="text-lg text-gray-300 font-satoshi font-semibold pt-8 px-40 text-center">
          ...
          <div className="text-lg text-gray-400 font-satoshi font-light py-20 flex flex-row gap-6">
            {features.map((item) => (
              <div
                key={item.title}
                className="items-center flex flex-col gap-6 text-center w-[480px] border border-gray-300 rounded-xl shadow-xl p-4"
              >
