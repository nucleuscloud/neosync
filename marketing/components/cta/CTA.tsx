  ...
  return (
    <div>
      <div className=" bg-gradient-to-r from-slate-50 to-zinc-300 border border-gray-400 shadow-xl rounded-xl">
        <div className="flex flex-col align-center space-y-6 py-10 justify-center ">
          <div className="flex flex-row gap-4 items-center px-10">
            <div className="flex flex-col gap-8 pl-10">
              ...
              <div className="text-md text-gray-800 font-satoshi font-semibold w-[70%]">
                Get started with Neosync Cloud or easily deploy open source
                Neosync using a Helm chart or Docker Componse file.
              </div>
                  ...
                  <Dialog>
                    <DialogTrigger asChild>
                      <Button variant="default">
                        Neosync Cloud{' '}
                        <ArrowRightIcon className="ml-2 h-5 w-8" />
                      </Button>
                    </DialogTrigger>
                    <DialogContent className="sm:max-w-lg bg-white p-6 shadow-xl">
                      <DialogHeader>
                        ...
                        <DialogDescription className="pt-6 text-gray-900 text-md text-center">
                          ...
                          yourself? Sign up for the private beta of Neosync
                          Cloud and get an environment.
                        </DialogDescription>
                      </DialogHeader>
