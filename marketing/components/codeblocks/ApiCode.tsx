...
import { Python } from '@/styles/icons/Python';
import { useEffect, useState } from 'react';
interface Props {
  code: string;
}

export default function ApiCodeBlock(props: Props) {
  const { code } = props;
  ...
  return (
    <div className="bg-[#1A1B1E] rounded-xl border border-gray-700 shadow-xl">
