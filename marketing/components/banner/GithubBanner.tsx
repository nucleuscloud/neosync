...
export default function GithubBanner(): ReactElement {
  ...
  return (
    <div>
      <div className="top-0 hidden lg:flex flex-row gap-3 justify-center w-full h-[35px] items-center bg-gradient-to-r from-violet-500 to-indigo-200 font-satoshi">
        <div>
