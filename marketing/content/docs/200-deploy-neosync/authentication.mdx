...
The descriptions of each environment variable detail exactly what the AUTH\_\* is and why it is needed.
...
This section details the AUTH*API*\* environment variables.
...
Reference the [environment variables](/deploy/environment-variables.mdx) page for the TEMPORAL\_\* environment variables.
