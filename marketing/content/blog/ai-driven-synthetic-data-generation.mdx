...
description: A guide to using AI to generate synthetic data
image: /images/blogs/llmheader.png
date: 2024-05-21
published: true
authors:
  - evis
...
Let's go through a walk-through example and guide.
...
2. Access to an LLM hosted at an endpoint. I'll be using OpenAI but you can use any åother LLM as long as it's available at a REST endpoint.
...
![trans-page](/images/blogs/openaiconn.png)
...
![new-trans](/images/blogs/llmcon.png)
...
![new-trans](/images/blogs/llmschema.png)
...
![new-trans](/images/blogs/llmprompt.png)
...
![new-trans](/images/blogs/llmprompt2.png)
...
![new-trans](/images/blogs/llmdata.png)
