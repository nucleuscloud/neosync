...
Nice! Okay, last step for Supabase. Let's get our connection string so we can connect to Supabase from Neosync. We can find our connection string by going to **Project Settings** then **Databse**. Under the **Connection parameters** heading, you can find your connection parameters to connect to your database.
...
| Username  | `postgres`                            | The username for authenticating the connection.               |
