...
Our first implementation of Neosync didn't optimize how many connections we were opening to the database which caused intermitant connection errors if we were opening too many without closing existing ones.
