...
func (_m *MockInterface) GetSubscriptions(customerId string) *subscription.Iter {
...
func (_c *MockInterface_GetSubscriptions_Call) Return(_a0 *subscription.Iter) *MockInterface_GetSubscriptions_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockInterface_GetSubscriptions_Call) RunAndReturn(run func(string) *subscription.Iter) *MockInterface_GetSubscriptions_Call {
	_c.Call.Return(run)
	return _c
}
