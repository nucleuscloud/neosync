INSERT INTO space_mission.astronauts (name, email, manager_astronaut_id, mentor_astronaut_id) VALUES
...
INSERT INTO space_mission.missions (name, description, status, lead_astronaut_id, client_astronaut_id) VALUES
...
INSERT INTO space_mission.objectives (title, description, status, mission_id, assignee_astronaut_id, reviewer_astronaut_id) VALUES
...
INSERT INTO space_mission.capabilities (name, category) VALUES
...
INSERT INTO space_mission.astronaut_capabilities (astronaut_id, capability_id, proficiency_level) VALUES
(1, 1, 5),
(2, 2, 4),
(3, 3, 5),
(4, 4, 4),
...
INSERT INTO space_mission.transmissions (
...
INSERT INTO space_mission.payloads (
...
INSERT INTO space_mission.crew_assignments (astronaut_id, mission_id, role) VALUES
(3, 1, 'Designer'),
(4, 2, 'Developer'),
(5, 3, 'Engineer'),
(6, 4, 'Researcher'),
...
INSERT INTO space_mission.mission_logs (object_type, object_id, action) VALUES
...
INSERT INTO space_mission.crews (crew_id, crew_name, lead_astronaut_id, parent_crew_id) VALUES
(1, 'Core Team', 1, NULL);
...
INSERT INTO space_mission.crew_missions (crew_id, mission_id, notes) VALUES
...
INSERT INTO space_mission.supplies (mission_id, bill_to_astronaut_id, owner_astronaut_id, total_amount, status)
VALUES
(1, 2, 1, 1200.00, 'Open'),    
(2, 4, 2, 2000.00, 'Open'),
...
INSERT INTO space_mission.supply_items (supply_id, objective_id, description, quantity, unit_price) VALUES
...
INSERT INTO space_mission.spacecraft_class (class_name, description) VALUES
('Explorer', 'Long-range exploration spacecraft'),
('Shuttle', 'Short-range transport spacecraft'),
('Station', 'Orbital research facilities');

INSERT INTO space_mission.spacecraft (name, class_id, launch_date, status) VALUES
('Discovery', 1, '2030-01-15', 'Active'),
('Voyager', 1, '2032-03-22', 'Active'),
('Atlantis', 2, '2029-11-05', 'Maintenance');

INSERT INTO space_mission.spacecraft_module (spacecraft_id, module_name, purpose, installation_date) VALUES
...
INSERT INTO space_mission.module_component (module_id, component_name, manufacturer, serial_number, installation_date) VALUES
...
INSERT INTO space_mission.equipment (name, category, weight_kg) VALUES
('Oxygen Tank', 'Life Support', 25.5),
('Solar Panel', 'Power', 35.2),
('Rover', 'Transportation', 150.0);

INSERT INTO space_mission.mission_equipment (mission_id, equipment_id, quantity, assignment_date) VALUES
(1, 1, 5, '2023-01-10'),
(1, 2, 8, '2023-01-12'),
(2, 1, 3, '2023-02-05');

INSERT INTO space_mission.equipment_maintenance (mission_id, equipment_id, maintenance_date, performed_by_astronaut_id, description) VALUES
...
INSERT INTO space_mission.training_courses (course_name, duration_hours, description) VALUES
...
INSERT INTO space_mission.course_prerequisites (course_id, required_course_id) VALUES
(2, 1), 
(3, 1), 
(3, 2); 

INSERT INTO space_mission.certifications (name, issuing_authority, valid_years) VALUES
...
INSERT INTO space_mission.astronaut_certifications (astronaut_id, certification_id, issue_date, expiry_date, certificate_number) VALUES
...
INSERT INTO space_mission.certification_requirements (certification_id, required_certification_id) VALUES
(2, 1), 
(3, 1), 
(3, 2); 

INSERT INTO space_mission.mission_logs_extended (mission_id, astronaut_id, log_date, log_type, severity, message) VALUES
...
INSERT INTO space_mission.communication_channels (name, frequency, encryption_level) VALUES
('Primary Comms', '2.4 GHz', 'High'),
('Emergency Channel', '121.5 MHz', 'Medium'),
('Science Data Link', '5.8 GHz', 'High');

INSERT INTO space_mission.mission_communications (mission_id, channel_id, priority, is_backup) VALUES
(1, 1, 1, FALSE),
(1, 2, 2, TRUE),
(2, 1, 1, FALSE);

INSERT INTO space_mission.message_logs (mission_id, channel_id, timestamp, sender_astronaut_id, content, is_encrypted) VALUES
...
INSERT INTO space_mission.events (event_time, severity, title, description)
VALUES 
...
-- INSERT INTO space_mission.system_events (
...
-- INSERT INTO space_mission.astronaut_events (
--     event_time, severity, title, description, 
...
-- INSERT INTO space_mission.mission_events (
--     event_time, severity, title, description, 
...
INSERT INTO space_mission.tags (name, category, created_by_astronaut_id) VALUES
('Urgent', 'Priority', 1),
('Technical', 'Category', 2),
('Research', 'Category', 3),
('Maintenance', 'Type', 4);

INSERT INTO space_mission.taggables (tag_id, taggable_type, taggable_id, created_by_astronaut_id) VALUES
(1, 'objectives', 2, 1),
(2, 'objectives', 2, 1),
(3, 'missions', 4, 3),
(4, 'spacecraft', 1, 2);
